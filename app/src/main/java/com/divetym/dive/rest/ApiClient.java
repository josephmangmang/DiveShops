...
public class ApiClient {
    private static final String BASE_ENDPOINT_URL_LOCAL = "http://192.168.254.100/v1/";
    private static final String BASE_ENPOINT_URL_ONLINE = "http://www.yourserver.com/v1/";
